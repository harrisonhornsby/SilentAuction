...
<body>
        ...
        <div id="divCollapse" class="collapse">
            <form class="form-horizontal" method="POST" action="CreateLot.php">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="description"  placeholder="Enter Lot Description" required>
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="container">
        ...
        <table class="table table-hover">
            ...
            <tbody>
            <?php
            $sql = "SELECT Lot.Id, Lot.Description, Lot.CategoryId, Category.Description as CategoryDescription, Lot.WinningBidderId, Lot.Delivered FROM Lot,Category Where Category.id=Lot.CategoryId";
