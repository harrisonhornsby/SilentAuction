...
<div class="container">
    ...
    <form class="form-horizontal" method="POST" action="UpdateLot.php?LotId=<?php echo $LotId ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="text" name="CategoryId" value="<?php echo $CategoryId ?>" required>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="number" name="Delivered" value="<?php echo $Delivered ?>">
            </div>
        </div>
        <div class="form-group">
