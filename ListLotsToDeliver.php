...
<div class="container">
    <h2>Lots Which are Paid For But Not Delivered</h2>
...
<table class="table table-hover">
  ...
  <?php
      ...
      $sql = "SELECT Bidder.Id, Bidder.Name, Bidder.Address, Bidder.CellNumber, Bidder.HomeNumber, Bidder.Email,Lot.id as 'Lot Id',Lot.Description, Lot.Paid,Lot.Delivered
FROM Bidder,Lot
WHERE Bidder.Id = Lot.WinningBidderId
AND Lot.Paid = 'Yes'
AND Lot.Delivered = 'No'";
